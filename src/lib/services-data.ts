...
export const servicesData: ServiceData[] = [
  ...
  },
  {
    ...
    whatItIs:
      "The HOCATT is a personal steam sauna capsule that combines 10 integrated technologies - transdermal ozone, CO₂ (carbonic acid), steam sauna with whole-body hyperthermia, far infrared, high-intensity PEMF, frequency specific microcurrents (FSM), concentrated oxygen breathing, essential oil infusions, photon light & color, and ultraviolet irradiation - into a single 30-minute session. You sit comfortably inside the capsule with your head outside, breathing pure oxygen while the combination of steam, ozone, and other modalities work synergistically to promote circulation, stimulate the immune system, support the body's natural detoxification pathways, and aid recovery.",
    whoItsFor: [
